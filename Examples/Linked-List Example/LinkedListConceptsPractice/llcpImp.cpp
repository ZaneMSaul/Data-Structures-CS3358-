...
{
   if (headPtr == 0 || headPtr->link == 0) return false;
   while (headPtr->link != 0 && headPtr->data != target)
      headPtr = headPtr->link;
   if (headPtr->link == 0) return false;
...
// definition of practice function 1

// definition of practice function 2

// add definitions of still more practice functions
